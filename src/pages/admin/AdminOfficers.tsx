...
export function AdminOfficers() {
  ...
  const officersList = !USE_MOCK_DATA
    ? apiOfficers.map((o) => ({
        ...
        name: typeof o.name === 'string' ? o.name : (o.name as any)?.name || 'Field Officer',
        badgeId: String(o.user_id || o.id || '').slice(0, 8).toUpperCase(),
        department: typeof o.department === 'string' ? o.department : o.department?.name || 'Department unavailable',
        designation: typeof o.designation === 'string' ? o.designation : (o.designation as any)?.name || 'Field Officer',
        email: typeof o.email === 'string' ? o.email : '',
        phone: typeof o.phone === 'string' ? o.phone : 'Not provided',
