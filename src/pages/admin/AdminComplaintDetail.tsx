            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                <a href={complaint.photoUrl} target="_blank" rel="noreferrer" className="block" aria-label="Open complaint evidence photo in a new tab">
                  <img src={complaint.photoUrl} alt="Complaint evidence" className="w-full max-h-96 object-contain rounded-md border border-slate-200 bg-white" loading="lazy" />
                </a>
              </div>
            </div>
          )}
      ...
      {complaint.status === 'RESOLVED' && complaint.resolution && (
        <Card className="border-2 border-emerald-300 shadow-md bg-emerald-50/40 text-left">
          ...
          <CardContent className="p-5 space-y-3 text-xs">
            ...
            {complaint.resolution.photoPreview && <img src={complaint.resolution.photoPreview} alt="Resolution Proof" className="w-full max-h-64 object-contain rounded border border-emerald-200 bg-white" loading="lazy" />}
          </CardContent>
        </Card>
      )}
    </div>
